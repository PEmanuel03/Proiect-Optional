...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/register_login_contact.css">
	<!-- END CSS -->
...
<div class="smallscreen">
	...
	<nav class="navbar navbar-toggleable-sd navbar-inverse">
		...
		<ul class="navbar-nav" id="target2">
			...
			<li class="nav-item">
				<a class="nav-link" href="#">Portofoliu</a>
			</li>';
			?>
			<li class="nav-item">
...
<div class="container">
	...
	<form action="include/send.inc.php" method="POST" autocomplete="off">
