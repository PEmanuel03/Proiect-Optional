...
?><?php
	...
	if(!isset($_SESSION['nume']))
	{
		...
		$select_result = mysqli_query($conectare, $select);
		$row_select = mysqli_fetch_assoc($select_result);
		}
...
<div class="container">
	<div class="content">
		...
		<?php 
			...
			echo '<form action="include/message.inc.php?id='.$row_select["From_M"].'&m=1" method="POST" autocomplete="off">
				<p class="formtext">Reply: </p><input type="hidden" name="subiect"  value="Reply('.$row_select["Subject"].')">
				<br>
